    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onBackPressed();
                Bungee.slideRight(RegisterBankAccountActivity.this);
            }
        });
        ...
        edstate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(RegisterBankAccountActivity.this, "Please select country first", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    showStateDialog();
        ...
        edbirth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(RegisterBankAccountActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            public void success(retrofit.client.Response response, retrofit.client.Response response2) {
                ...
                try {
                    ...
                    else
                    {
                        ...
                        Toast.makeText(RegisterBankAccountActivity.this, ""+stringBuilder, Toast.LENGTH_SHORT).show();
                    }
            ...
            public void success(retrofit.client.Response response, retrofit.client.Response response2) {
                ...
                try {
                    ...
                    if (stringBuilder != null || !stringBuilder.toString().equalsIgnoreCase("")) {
                        ...
                        {
                            new AlertDialog.Builder(RegisterBankAccountActivity.this).setMessage("Are you sure you want to save the changes?")
                        ...
                        else
                        {
                            ...
                            new AlertDialog.Builder(RegisterBankAccountActivity.this).setMessage("You cannot update profile if you have any trips remaining!").setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (stringBuilder != null || !stringBuilder.toString().equalsIgnoreCase("")) {
                                ...
                                if(status.equalsIgnoreCase("1"))
                                {
                                    ...
                                    for(int i=0;i<jsonArray.length();i++)
                                    {
                                        ...
                                        //Toast.makeText(RegisterBankAccountActivity.this, "Please submit your profile for approval", Toast.LENGTH_LONG).show();
                                        finish();
                                    }
                                ...
                                {
                                    Toast.makeText(RegisterBankAccountActivity.this, ""+jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                                }
